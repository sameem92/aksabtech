...
@section('title') لوحة التحكم |  سلايدر الموقع  @endsection
@section('content')
      ...
      <div class="container">
        <div class="row">
            ...
            {{ Form::open(array('method' => 'PATCH','files' => true,'class' => 'card','url' =>'b3k0P4XGvvy+PzGjt5qLS873ORhSE7mZ1fok9lKNit0/setapp/'.$changelogo->id )) }}
                <input type="hidden" name="homeslidermockup">
                
                <div dir="rtl" class="card-header">
                  <h3 class="card-title">تغيير صورة المجسم</h3>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <div style="margin-bottom: 0;" class="login-logo">
                                <img class="img-thumbnail"  src="{{asset('users/images/'.$changelogo->homeslidermockup)}}" alt="chooseusbgimage"><br>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <label class="form-label">صورة المجسم</label>
                                <input style="width:100%;" type="file" class="form-control" name="homeslidermockup">
                                @if ($errors->has('homeslidermockup'))
                                <div style="color: crimson;font-size: 18px;" class="error">{{ $errors->first('homeslidermockup') }}</div>
                                @endif
                            </div>
                        </div>
