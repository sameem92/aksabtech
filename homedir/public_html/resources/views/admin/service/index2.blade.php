...
@section('title') لوحة التحكم |  خدماتنا  @endsection
@section('content')
      ...
      <div class="container">
        <div class="row">
            ...
            {{ Form::open(array('method' => 'PATCH','files' => true,'class' => 'card','url' =>'b3k0P4XGvvy+PzGjt5qLS873ORhSE7mZ1fok9lKNit0/setapp/'.$changelogo->id )) }}
                <input type="hidden" name="updateserviceinfo">
                
                <div dir="rtl" class="card-header">
                  <h3 class="card-title">تغيير بيانات سكشن خدماتنا</h3>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea dir="rtl" rows="5" style="width:100%;" type="text" placeholder="الجملة التعريفية" class="form-control" name="servicetext"> {{$changelogo->servicetext}}</textarea>
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <div style="margin-bottom: 0;" class="login-logo">
                                <img class="img-thumbnail"  src="{{asset('users/images/'.$changelogo->servicemockup)}}" alt="chooseusbgimage"><br>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <label class="form-label">صورة خلفية سكشن خدماتنا</label>
                            <div style="margin-bottom: 0;" class="login-logo">
                                <img class="img-thumbnail"  src="{{asset('users/images/'.$changelogo->servicesbgimage)}}" alt="servicesbgimage"><br>
                            </div>
                        </div>

                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <label class="form-label">صورة خلفية خدماتنا</label>
                                <input style="width:100%;" type="file" class="form-control" name="servicesbgimage">
                                @if ($errors->has('servicesbgimage'))
                                <div style="color: crimson;font-size: 18px;" class="error">{{ $errors->first('servicesbgimage') }}</div>
                                @endif
                            </div>
                        </div>
